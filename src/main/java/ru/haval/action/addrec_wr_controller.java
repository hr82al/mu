...
//
	...
	private void addOneOfWr() {
		...
		actual_time1_wr_add8.setText("" + fix_time(w_data_begin8, w_data_end8, b_picker8, e_picker8));
//FIXME
//		LocalTime startTime = b_picker.getValue();
//		LocalDate startDate = w_data_begin.getValue();
//		LocalTime endTime = e_picker.getValue();
//		LocalDate endDate = w_data_end.getValue();
//		String ap_num = numap_wr_add.getText().substring(2);
//		String Task_Report = req_action_wr_add.getText();
//		s_class.addWorkRecord(ap_num, Task_Report, startTime, startDate, endTime, endDate);
//
