...
public class hmmr_wp_model implements WrTable {
	...
	public hmmr_wp_model()
	{
		
	}
	public hmmr_wp_model(String Id, String PM_Num, String Type, String Desc, String Due_Date, String Equip, String inst_btn, String OFT, String OTV, String tsk_maker, String flag_otv, String flag_oft, String flag_tm, String icon)
	{
		this.Id.set(Id);
