...
public class AttributesHelper {
    ...
    public static final Map<String, Color> COLOR_MAPPINGS = new HashMap<String, Color>();
        ...
        try {
            ...
            if ((len >= AttributesHelper.HASHSHORT_NO_ALPHA)
                ...
                if (len == AttributesHelper.HASHSHORT_ALPHA) {
                    alpha = Integer
                            .parseInt(
                                    value.substring(AttributesHelper.HASHSHORT_NO_ALPHA),
                                    AttributesHelper.HEXBASE)
                            / AttributesHelper.MAX_HEXCHAR_AS_FLOAT;
                }
    ...
    static {
        ...
        AttributesHelper.SIZETRANSLATIONS
                .put(OperatorDictionary.NAME_INFINITY,
        ...
        AttributesHelper.ABSOLUTE_UNITS.put("pc",
                AttributesHelper.PT_PER_PC);
        ...
        AttributesHelper.COLOR_MAPPINGS.put("fuchsia", new Color(255, 0,
                255));
        ...
        AttributesHelper.COLOR_MAPPINGS.put("purple",
                new Color(128, 0, 128));
        AttributesHelper.COLOR_MAPPINGS.put("red", Color.RED);
        AttributesHelper.COLOR_MAPPINGS.put("silver", new Color(192, 192,
                192));
